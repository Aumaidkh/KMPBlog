package com.hopcape.androidapp.presentation.components
...
import com.hopcape.androidapp.data.BlogPost
...
@Composable
fun PostCardsView(
    posts: RequestState<List<BlogPost>>,
    topMargin: Dp,
...
fun String.decodeThumbnailImage(): String {
    return this
}
